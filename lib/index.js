(function() {
  var ALGORITHM_REGEXP, PluginError, Q, RATIO_REGEXP, URL_REGEXP, Vinyl, async, coordinates, cssContent, cssDeclarations, cssParser, cssRules, cssStream, fs, imgStream, inherit, path, sprites, spritesmith, through;
