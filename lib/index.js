(function() {
  var ALGORITHM_REGEXP, Q, URL_REGEXP, X2_REGEXP, async, coordinates, cssContent, cssDeclarations, cssParser, cssRules, cssStream, fs, gutil, imgStream, inherit, path, sprites, spritesmith, through;
  ...
  cssDeclarations = function(filePath, declarations, opt) {
    ...
    return Q.Promise(function(resolve, reject) {
      var coordinate, decs, height, width, zoom;
      decs = [];
      zoom = 1;
      coordinate = null;
      width = '';
