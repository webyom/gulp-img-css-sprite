(function() {
  var URL_REGEXP, async, coordinates, css, cssDeclarations, cssParser, cssRules, fs, gutil, img, inherit, path, spritesmith, through;
  ...
  css = function(opt) {
    ...
    return stream = through.obj(function(file, enc, next) {
      ...
      if (URL_REGEXP.test(content)) {
        ...
        return cssRules(file, ast.stylesheet.rules || [], (function(_this) {
          return function() {
